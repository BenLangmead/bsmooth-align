...
##
# BtlBio::Index::Bowtie2::Index
#
# For building and checking the existence of Bowtie 2 indexes.
#
# Author: Ben Langmead
# Email: langmea@cs.jhu.edu
#

package BtlBio::Index::Bowtie2::Index;
require Exporter;
@ISA = qw(Exporter);
@EXPORT = qw(bowtie2_index_exists);

##
# Given index basename, check that all the index files are there.
#
sub bowtie2_index_exists($) {
